...
function registration($email, $password) {
	...
	//$conn = pg_connect("host=localhost port=5432 dbname=postgres user=WebUser password=ga1{cgDcD#");	
		//$conn = pg_connect("host=localhost port=5435 dbname=postgres user=postgres");
	
	$conn = pg_connect("host=127.0.0.1 port=5432 dbname=postgres user=postgres password=1234567890");
	...
	$query = pg_query($conn, "INSERT INTO postgres.users (email, password) VALUES ('" . $email . "','" . $password . "')");
...
function authorization($email, $password) {
	...
	//$conn = pg_connect("host=localhost port=5432 dbname=postgres user=WebUser password=ga1{cgDcD#");
	//$conn = pg_connect("host=localhost port=5435 dbname=postgres user=postgres");	
	$conn = pg_connect("host=localhost port=5432 dbname=postgres user=postgres password=1234567890");
