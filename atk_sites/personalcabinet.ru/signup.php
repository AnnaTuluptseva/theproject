...
if(isset($_POST['commit'])) {
	...
	if($errors['email'] == '' && $errors['password'] == '' && $errors['password2'] == '' && $errors['email'] == '') {
		...
		if($reg === true) {
			$message = '<p>Вы успешно зарегистрировались в системе. Сейчас вы будете переадресованы к странице авторизации. Если это не произошло, перейдите на неё по <a href="index.php">прямой&nbsp;ссылке</a>.</p>';
